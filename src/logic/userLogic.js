...
kakaoSignin : async function(jwtToken, accessToken){
    ...
    let kakaoUserInfo = await request(option)
        ...
        //jwt를 안받은 경우
            ...
            await console.log("kakaoUserInfo : " + kakaoUserInfo.id)
            await console.log("dbUserInfo " + dbUserInfo)
            ...
            //새로운 회원 
                ...
                // .then((result) => {
                //     return jwt.sign(kakaoUserInfo.id, "0")
                // }).then((result) => {
                //     console.log(result)
                //     return {
                //         id: kakaoUserInfo.id,
                ...
                newToken = jwt.sign(kakaoUserInfo.id, 0)
